package com.fis.fis_remote_learning.utils;
...
import static com.fis.fis_remote_learning.utils.BaseUrl.BusinessShortCode;
import static com.fis.fis_remote_learning.utils.BaseUrl.Passkey;
import static com.fis.fis_remote_learning.utils.BaseUrl.callbackurl;
import static com.fis.fis_remote_learning.utils.BaseUrl.transctionDesc;
...
public class Utils {
    ...
    public static void ShowFailedPopup(Context context, String Title, String Message) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(context);
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.failed_layout, null);
        builder.setView(view);
        final AlertDialog dialog = builder.create();
        Objects.requireNonNull(dialog.getWindow()).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
