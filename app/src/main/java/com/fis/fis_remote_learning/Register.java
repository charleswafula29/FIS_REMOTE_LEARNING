...
import com.fis.fis_remote_learning.models.RegistrationModel;
...
import static com.fis.fis_remote_learning.utils.Utils.RegistrationSuccessPopup;
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    try {
                                        ...
                                        if(statusModel.getCode().equals("1")){
                                            AlertDialog dialog = RegistrationSuccessPopup(com.fis.fis_remote_learning.Register.this);
                                            startActivity(new Intent(Register.this,Login.class));
                                            dialog.show();
